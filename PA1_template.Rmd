...
```{r impute_missing_with_median,echo=T,fig.width=8}
...
```{r impute_missing_with_mean,echo=T,fig.width=8}
...
- The mean number of steps per day is `r meanfixedstepsperday.mean`, vs. `r meanstepsperday` steps without imputing values; a difference of `r prettyNum(meandiff.mean)` steps. 
- The median number of steps per day is `r medianfixedstepsperday.mean`, vs. `r medianstepsperday` steps without imputing values; a difference of `r prettyNum(mediandiff.mean)` steps. 
